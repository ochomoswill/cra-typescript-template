...
module.exports = {
  ...
  '@code-family': 'Consolas, monospace',
  ...
  '@input-border-color': '#C3D1DE',
  '@input-hover-border-color': '#c3d1de',
  ...
  '@select-item-selected-bg': "#f2f4f8",
  '@select-item-active-bg': "#f2f4f8",
};
